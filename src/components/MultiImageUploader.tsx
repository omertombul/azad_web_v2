    ...
    <div>
      ...
      <div className="flex gap-2 mt-3">
        <input
          ...
          className="flex-1 px-3 py-2 text-sm border border-gray-200 rounded-lg bg-white text-gray-800 placeholder-gray-400 focus:outline-none focus:border-brand-gold/50 focus:ring-1 focus:ring-brand-gold/20"
        />
        <button
          type="button"
          onClick={addFromUrl}
          disabled={!linkUrl.trim()}
          className="px-4 py-2 text-sm font-medium bg-brand-gold text-white rounded-lg hover:bg-brand-gold/90 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
        >
          Add
        </button>
      </div>
